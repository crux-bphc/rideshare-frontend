...
mixin _$Ride {
 ...
 int get id; String get createdBy; String? get comments; DateTime? get departureStartTime; DateTime? get departureEndTime; bool? get isBookmarked; int? get maxMemberCount; String? get rideStartLocation; String? get rideEndLocation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdBy,comments,departureStartTime,departureEndTime,isBookmarked,maxMemberCount,rideStartLocation,rideEndLocation);

@override
String toString() {
  return 'Ride(id: $id, createdBy: $createdBy, comments: $comments, departureStartTime: $departureStartTime, departureEndTime: $departureEndTime, isBookmarked: $isBookmarked, maxMemberCount: $maxMemberCount, rideStartLocation: $rideStartLocation, rideEndLocation: $rideEndLocation)';
}
...
@useResult
$Res call({
 int id, String createdBy, String? comments, DateTime? departureStartTime, DateTime? departureEndTime, bool? isBookmarked, int? maxMemberCount, String? rideStartLocation, String? rideEndLocation
});
...
/// Create a copy of Ride
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdBy = null,Object? comments = freezed,Object? departureStartTime = freezed,Object? departureEndTime = freezed,Object? isBookmarked = freezed,Object? maxMemberCount = freezed,Object? rideStartLocation = freezed,Object? rideEndLocation = freezed,}) {
...
as bool?,maxMemberCount: freezed == maxMemberCount ? _self.maxMemberCount : maxMemberCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String createdBy,  String? comments,  DateTime? departureStartTime,  DateTime? departureEndTime,  bool? isBookmarked,  int? maxMemberCount,  String? rideStartLocation,  String? rideEndLocation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ride() when $default != null:
return $default(_that.id,_that.createdBy,_that.comments,_that.departureStartTime,_that.departureEndTime,_that.isBookmarked,_that.maxMemberCount,_that.rideStartLocation,_that.rideEndLocation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String createdBy,  String? comments,  DateTime? departureStartTime,  DateTime? departureEndTime,  bool? isBookmarked,  int? maxMemberCount,  String? rideStartLocation,  String? rideEndLocation)  $default,) {final _that = this;
switch (_that) {
case _Ride():
return $default(_that.id,_that.createdBy,_that.comments,_that.departureStartTime,_that.departureEndTime,_that.isBookmarked,_that.maxMemberCount,_that.rideStartLocation,_that.rideEndLocation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String createdBy,  String? comments,  DateTime? departureStartTime,  DateTime? departureEndTime,  bool? isBookmarked,  int? maxMemberCount,  String? rideStartLocation,  String? rideEndLocation)?  $default,) {final _that = this;
switch (_that) {
case _Ride() when $default != null:
return $default(_that.id,_that.createdBy,_that.comments,_that.departureStartTime,_that.departureEndTime,_that.isBookmarked,_that.maxMemberCount,_that.rideStartLocation,_that.rideEndLocation);case _:
  return null;
...
class _Ride implements Ride {
  const _Ride({required this.id, required this.createdBy, this.comments, this.departureStartTime, this.departureEndTime, this.isBookmarked, this.maxMemberCount, this.rideStartLocation, this.rideEndLocation});
...
/// Create a copy of Ride
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdBy = null,Object? comments = freezed,Object? departureStartTime = freezed,Object? departureEndTime = freezed,Object? isBookmarked = freezed,Object? maxMemberCount = freezed,Object? rideStartLocation = freezed,Object? rideEndLocation = freezed,}) {
  return _then(_Ride(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,createdBy: null == createdBy ? _self.createdBy : createdBy // ignore: cast_nullable_to_non_nullable
as String,comments: freezed == comments ? _self.comments : comments // ignore: cast_nullable_to_non_nullable
