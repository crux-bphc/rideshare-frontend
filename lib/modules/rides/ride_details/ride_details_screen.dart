    ...
    return FutureBuilder<User?>(
      ...
      builder: (context, creatorSnapshot) {
        ...
        if (creatorSnapshot.hasError ||
            !creatorSnapshot.hasData ||
            creatorSnapshot.data == null) {
          return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          (ride.departureEndTime!.day ==
                                  ride.departureStartTime!.day)
                        ...
                        if (!isCurrentUserMember) {
                          return FutureBuilder(
                            ...
                            builder: (context, sentRequestsSnapshot) {
                              ...
                              final sentRequests =
                                  sentRequestsSnapshot.data ?? [];
                              final hasSentRequest = sentRequests.any(
                                (request) => request.id == ride.id,
                              );
                                    ...
                                    try {
                                      ...
                                      if (context.mounted) {
                                        ScaffoldMessenger.of(
                                          ...
                                          const SnackBar(
                                            content: Text(
                                              'Successfully sent request to join the Ride!',
                                            ),
